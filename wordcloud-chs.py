...
stopwords = {}
isCN = 1 #默认启用中文分词
back_coloring_path = "./photo.jpg" # 设置背景图片路径
text_path = '百度.txt' #设置要分析的文本路径
font_path = './source/simkai.ttf' # 为matplotlib设置中文字体路径没
stopwords_path = './source/stopwords.txt' # 停用词词表
...
text = codecs.open(path.join(d, text_path),"r","utf-8").read()
